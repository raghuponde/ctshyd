                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseEmp" class="accordion-collapse collapse show" data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
                                <a href="/EmployeeUI/Index" class="d-block mb-2">Employee Data</a>
                            </div>
                        </div>
                    </div>
                </div>
...
4. Sample Details.cshtml (Card-style details page)
html
Copy
Edit
@{
...
The same card layout can be reused for Edit.cshtml and Delete.cshtml with appropriate modifications (e.g., form inputs for Edit, confirm message for Delete).
...
<script>
 ...
 Updated Index.cshtml with Pagination & Search
html
Copy
Edit
@{
